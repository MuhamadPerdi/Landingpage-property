                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('artikel.update', $artikel->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" title="title" value="{{ old('title', $artikel->title) }}" name="title"  autofocus>
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" >{{ old('deskripsi', $artikel->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            @if ($artikel->foto)
                                <img src="{{ asset('storage/images/artikel/' . $artikel->foto) }}" alt="image" class="mt-2" style="max-width: 200px;">
                            @endif
                        </div>
